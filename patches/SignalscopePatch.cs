...
namespace SbekuMod.patches
{
    ...
    public class SignalscopePatch
    {
        ...
        public static bool Signalscope_SetDefaultValuesOnDeserialized_Prefix(Signalscope __instance, int increment = 1)
        {
            __instance._frequencyFilterIndex += increment;
            __instance._frequencyFilterIndex = ((__instance._frequencyFilterIndex > 7) ? 1 : __instance._frequencyFilterIndex);
            __instance._frequencyFilterIndex = ((__instance._frequencyFilterIndex < 1) ? 7 : __instance._frequencyFilterIndex);
